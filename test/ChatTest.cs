...
";
    ...
    public async Task OpenfriendExistingChatChat()
    {
        ...
        var insertUsers = $@"INSERT INTO keepsocial.chatroom_users_relation (rom_id, user_id) values (101, 111);
                            INSERT INTO keepsocial.chatroom_users_relation (rom_id, user_id) values (101, 112);";
        var sql = $@"
            select 
            keepsocial.chatrooms.rom_id as {nameof(Rooms.rom_id)},
            rom_name as {nameof(Rooms.rom_name)}
